...
class PdfExtractionHomeScreen extends StatefulWidget {
  ...
  PdfExtractionHomeScreen({required this.onFileUploaded});

  @override
  _PdfExtractionHomeScreenState createState() => _PdfExtractionHomeScreenState();
}

class _PdfExtractionHomeScreenState extends State<PdfExtractionHomeScreen> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    _buildPermissionStatus('Storage', _permissionStatus[Permission.storage] ?? false),
                    _buildPermissionStatus('Photos', _permissionStatus[Permission.photos] ?? false),
                    _buildPermissionStatus('Manage Storage', _permissionStatus[Permission.manageExternalStorage] ?? false),
                    SizedBox(height: 8),
                    Row(
